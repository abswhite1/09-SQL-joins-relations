...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    ...
    client.query(
      ...
      function(err) {
        if (err) console.error(err);
        // DONE: What number in the full-stack diagram best matches what is happening in line 114? #5 is occuring, as the server is providing a response to the user from the database regarding the completion of the record insertion.
